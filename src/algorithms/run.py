...
def run_algo_locally(algorithm, dataset, algorithm_params=None, cpu_limit="1", mem_limit=None, pipeline=False):
    """
    ...
    algo = factory.build_algorithm(algorithm, mem_limit, cpu_limit, conf = algorithm_params, pipeline = pipeline)
...
def run_algo_docker(algorithm, dataset, algorithm_params=None, cpu_limit=None, mem_limit=None, pipeline=False, step=False):
    """
    ...
    if algorithm_params:
        ...
        algorithm_params=set_algorithm_params(algorithm_params, mem_limit, str(cpu_limit))
...
def run_pipeline_locally(algorithm, dataset, cpu_limit=None, mem_limit=None, algorithm_params=None, pipeline=False, step=False):
